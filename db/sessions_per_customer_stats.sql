SELECT
    ...
    sum(CASE WHEN type = 'desktop' and activated = true THEN 1 ELSE 0 END)::integer as web_count,
    sum(CASE WHEN type = 'mobile' and activated = true THEN 1 ELSE 0 END)::integer as mobile_count,
