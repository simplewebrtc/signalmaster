...
const TotalSessionsCounter = require('./reports/total_sessions');
const MaxConcurrentSessionsCounter = require('./reports/max_concurrent_sessions');
...
class RoomReporter {
  ...
  async process_room(room_event) {
    ...
    reporters.set('totalSessions', new TotalSessionsCounter());
    reporters.set('activeSessions', new MaxConcurrentSessionsCounter());
